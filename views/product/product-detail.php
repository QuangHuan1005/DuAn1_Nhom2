...
<main>
    ...
    <div class="container margin_30">
        <div class="countdown_inner">
            -20% Ưu đãi này kết thúc sau <div data-countdown="2025/05/25" class="countdown"></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="prod_info">
                    ...
                    <p><small>SKU: MTKRY-00<?= (int)$product['id'] ?></small></p>
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php if (isset($_SESSION['user'])): ?>
                                    <form method="post" action="index.php?act=add_comment">
                                        <input type="hidden" name="product_id" value="<?= (int)$product['id'] ?>">
                                        <textarea name="content" rows="4" cols="50" required placeholder="Nhập bình luận..."></textarea><br>
                ...
                <div class="grid_item">
                    ...
                    <figure>
                        <a href="product-detail-1.html">
                            <img class="owl-lazy" src="img/products/product_placeholder_square_medium.jpg" alt="Sản phẩm mẫu">
                        </a>
                    </figure>
                    <div class="rating">
                    ...
                    <ul>
                        <li><a href="#0" class="tooltip-1" data-bs-toggle="tooltip" title="Yêu thích"><i class="ti-heart"></i></a></li>
                        <li><a href="#0" class="tooltip-1" data-bs-toggle="tooltip" title="So sánh"><i class="ti-control-shuffle"></i></a></li>
                        <li><a href="#0" class="tooltip-1" data-bs-toggle="tooltip" title="Thêm vào giỏ"><i class="ti-shopping-cart"></i></a></li>
                    </ul>
                </div>
            </div>
            <!-- /item -->
