			...
			<div class="container">
				<div class="row small-gutters">
					<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
						<div id="logo">
							<a href="index-2.html"><img src="./assets/allaia/img/logo.svg" alt="" width="100" height="35"></a>
						</div>
					</div>
					<nav class="col-xl-6 col-lg-7">
						...
						<div class="main-menu">
							<div id="header_menu">
								<a href="index-2.html"><img src="./assets/allaia/img/logo_black.svg" alt="" width="100" height="35"></a>
							...
							<ul>
								...
								<li class="megamenu submenu">
									<a href="?act=page" class="show-submenu-mega">Sản phẩm</a>
					...
					<div class="col-xl-3 col-lg-2 d-lg-flex align-items-center justify-content-end text-end">
						<a class="phone_top" href="tel://9438843343"><strong><span>Liên hệ hotline:</span>+94 423-23-221</strong></a>
					</div>
				</div>
				<!-- /row -->
			</div>
