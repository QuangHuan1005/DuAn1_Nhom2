			...
			<div class="row add_bottom_25">
				<div class="col-lg-6">
					<ul class="footer-selector clearfix">
						...
						<li><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="./assets/allaia/img/cards_all.svg" alt="" width="198" height="30" class="lazy"></li>
					</ul>
				</div>
				<div class="col-lg-6">
	...
	<!-- COMMON SCRIPTS -->
    <script src="./assets/allaia/js/common_scripts.min.js"></script>
    <script src="./assets/allaia/js/main.js"></script>
	
	<!-- SPECIFIC SCRIPTS -->
	<script src="./assets/allaia/js/carousel-home.min.js"></script>
	<!-- SPECIFIC SCRIPTS -->
